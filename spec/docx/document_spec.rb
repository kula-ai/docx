...
describe Docx::Document do
  ...
  describe 'streaming' do
    ...
    # Regression: #update wrote parts back by positional index, but glob
    # order is not always numeric — so an out-of-order part was written to
    # the wrong file, blanking the referenced header on stream.
